...
| | |
| --- | --- |
| Crates in the tree | 283 |
| Covered by a shared audit | 38 |
| Exemptions — this workspace asserting it has not looked | 245 |
...
`windows-sys`, `kurbo` and `serde_json` have no audit in any shared set**. `postcard`
does.
