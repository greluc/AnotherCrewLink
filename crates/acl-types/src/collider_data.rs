// GENERATED by scripts/port-collider-data.mjs from src/common/ColliderMap.ts.
...
pub(crate) fn door_for(map: MapType, door_id: u32) -> Option<&'static str> {
    match map {
        MapType::MiraHq => match door_id {
            0 => Some("M 44.942 37.086 H 47.27"),
            1 => Some("M 44.942 30.499 H 47.27"),
            _ => None,
        },
        MapType::Polus => match door_id {
            0 => Some("M 51.257 48.531 V 50.205"),
            1 => Some("M 48.14 50.544 H 46.811 "),
            2 => Some("M 44.751 53.131 H 46.111"),
            3 => Some("M 44.798 58.095 H 46.244 "),
            4 => Some("M 45.244 61.962 H 46.577"),
            5 => Some("M 52.257 60.719 H 53.791"),
            6 => Some("M 50.113 58.923 H 51.646"),
            7 => Some("M 68.703 56.136 V 57.763"),
            8 => Some("M 57.403 60.87 V 62.541"),
            9 => Some("M 65.938 48.445 H 67.311"),
            10 => Some("M 64.738 48.655 V 50.384"),
            11 => Some("M 57.193 49.972 V 51.668"),
            12 => Some("M 65.475 63.639 V 65.376"),
            13 => Some("M 63.226 63.121 H 64.575"),
            14 => Some("M 77.996 50.401 V 48.711"),
            15 => Some("M 78.363 50.967 H 79.756"),
            _ => None,
        },
        MapType::TheSkeld => match door_id {
            0 => Some("M 45.059 37.568 V 39.744 "),
            3 => Some("M 38.371 44.717 H 40.207"),
            8 => Some("M 33.649 37.568 V 39.787"),
            10 => Some("M 29.977 39.787 H 31.77"),
            2 => Some("M 25.3 39.787 V 37.568 "),
            5 => Some("M 22.196 41.945 H 23.989"),
            6 => Some("M 25.154 44.051 V 46.183"),
            4 => Some("M 22.196 48.663 H 24.169"),
            11 => Some("M 25.412 52.405 V 50.274"),
            9 => Some("M 29.628 53.101 H 31.333"),
            1 => Some("M 34.786 55.353 V 53.101"),
            7 => Some("M 38.371 48.231 H 40.207"),
            12 => Some("M 41.081 52.971 V 50.839"),
            _ => None,
        },
        MapType::Airship => match door_id {
            0 => Some("M 23.8376 41.7526 V 39.96"),
            1 => Some("M 31.1709 39.96 V 41.9155"),
            2 => Some("M 27.5694 39.6096 H 25.8339"),
            3 => Some("M 28.295 41.9155 H 29.833"),
            4 => Some("M 38.428 32.5452 H 39.753"),
            5 => Some("M 36.3043 31.9748 V 30.424"),
            6 => Some("M 42.6598 30.224 V 32.012 "),
            7 => Some("M 31.122 46.3563 V 48.0104"),
            8 => Some("M 31.2524 51.1229 V 52.7363"),
            9 => Some("M 38.4228 50.8785 V 52.8341"),
            10 => Some("M 44.1346 39.0229 V 40.8155"),
            11 => Some("M 57.426 39.117 V 40.8155"),
            12 => Some("M 56.418 31.3637 V 29.788"),
            13 => Some("M 64.008 29.7748 V 38.1674"),
            14 => Some("M 59.078 34.0118 H 60.578"),
            15 => Some("M 68.5709 33.197 H 70.0376"),
            16 => Some("M 70.005 33.197 H 71.4228"),
            17 => Some("M 71.5857 33.197 H 72.9709"),
            18 => Some("M 73.1339 33.197 H 74.4376"),
            19 => Some("M 61.2946 47.66 V 49.1674"),
            20 => Some("M 71.708 44.3274 H 73.3457"),
            _ => None,
        },
        MapType::Fungle => match door_id {
            0 => Some("M 62.95 27.87 H 65.34"),
            1 => Some("M 58.53 27.51 V 25.63"),
            2 => Some("M 23.51 45.57 H 25.44"),
            3 => Some("M 34.65 47.6 H 36.84"),
            4 => Some("M 50.9 38.43 V 35.82"),
            5 => Some("M 51.38 33.62 H 53.88"),
            6 => Some("M 59.52 47.91 V 45.62"),
            7 => Some("M 38.31 36.76 V 34.37"),
            _ => None,
        },
        _ => None,
    }
